...
def main():
    ...
    print()
    print("Optional (Ad settings, defaults shown):")
    print(f"  AD_PROVIDER           = monetag  (options: monetag / adsense / none)")
    print(f"  AD_ZONE_ID            = 229646   (Monetag zone ID or AdSense ca-pub-XXXX)")
    print()
    print("Ad revenue strategy:")
    print("  - NOW: Monetag ads auto-inserted in every article (earn from day 1)")
    print("  - AFTER 30+ articles: Apply AdSense via Blogger Earnings dashboard")
    print("  - AFTER AdSense approved: Change AD_PROVIDER to 'adsense'")
    print()
